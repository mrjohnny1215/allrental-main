...
(async () => {
  ...
  const urls = [
    'https://www.rentalsegye.com/product_list.php?cid=1377&gid=1424',
    'https://www.rentalsegye.com/product_list.php?cid=1377&gid=1423',
    'https://www.rentalsegye.com/product_list.php?cid=1379&gid=1424',
  ];
  for (const u of urls) {
    try {
      ...
      console.log('\n=== '+u+' ===');
      if(data.length===0) console.log('(필터 없음)');
